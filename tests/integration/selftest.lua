...
check("i18n loads catalogs and translates", function()
  local lang = require("aurora.lang")
  assert(lang.loadDir("/etc/locale") >= 2, "en + ru catalogs load")
  lang.setLocale("ru")
  assertEq(lang.t("sys.memory"), "Память", "russian translation")
  lang.setLocale("en")
  assertEq(lang.t("sys.memory"), "Memory", "english fallback/value")
end)
